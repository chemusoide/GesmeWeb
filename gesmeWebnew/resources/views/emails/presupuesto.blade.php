...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                        ...
                        <tr><td align="left" valign="middle">
                            ...
                            <table width="115" border="0" cellspacing="0" cellpadding="0" >
                                <tr><td align="left" valign="top" class="mob_center">
                                    <a href="http://www.dpicode.com" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                    <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
                                    <img src="http://www.dpicode.com/media/logo-black.png" width="177" height="47" alt="Dpicode" border="0" style="display: block;" /></font></a>
                                </td></tr>
                            </table>                        
                        </td></tr>
                                ...
                                <tr><td align="right">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr><td width="30" align="center" style="line-height: 19px;">
                                            <a href="https://www.facebook.com/dpicode" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                            ...
                                            <a href="https://twitter.com/dpicode" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                            <font face="Arial, Helvetica, sans-serif" size="2" color="#596167">
    ...
    <tr><td align="center" bgcolor="#EFEFEF">
        <table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr><td align="center">
                ...
                <div style="line-height: 44px;">
                    ...
                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
                        Gracias por contactar con Dpicode
                    </span></font>
                </div>
            ...
            <tr><td align="center">
                <div style="line-height: 24px;">
                    ...
                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                        Genial!! Tenemos tu petición de presupuesto. <br/ >
            ...
            <tr><td align="center">
                <div style="line-height: 24px;">
                        <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167"> Atentamente el equipo de <strong>Dpicode</strong></font>
                </div>
                <!-- padding --><div style="height: 60px; line-height: 60px; font-size: 10px;"> </div>
            </td></tr>
            <?/*<tr><td align="center">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr><td align="center">
                ...
                <span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                    2015 © <a href="http://www.dpicode.com">dpicode</a>. Todos los derechos reservados.
                </span></font>              
            </td></tr>          
        </table>
