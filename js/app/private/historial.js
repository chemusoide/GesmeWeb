...
function imprimirHistorial(){
	...
	$( "#divInputAdd").append('<input type="hidden" name="impingreso" id="impListingreso">');
	...
	//$('#impingreso').val(($('#impingreso') && $('#impingreso').is(":checked"))?'S':'N');
	//if($('#impingreso').val() == 'N'){
		
		crearInputAntecedentes(listIngrBusq, 'ingreso');
	//}
